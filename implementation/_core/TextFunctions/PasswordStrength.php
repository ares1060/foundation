...
class PasswordStrength {
    ...
    public function calculateAll() {
        ...
        $scoreInfoNumber = $this->getScoreInfoNumber($averageScore);
        ...
        $this->passwordInfo['averageScoreInfoNumber'] = $scoreInfoNumber;
    }
	...
	private function getScoreInfoNumber($score) {
        if ($score <= 15) {
            $scoreInfo = 0;
        } else if ($score <= 35) {
            $scoreInfo = 1;
